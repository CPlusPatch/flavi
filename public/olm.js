	...
	var Module = (() => {
		...
		return function (Module) {
			...
			if ("undefined" !== typeof OLM_OPTIONS)
				for (var ea in OLM_OPTIONS)
					OLM_OPTIONS.hasOwnProperty(ea) && (a[ea] = OLM_OPTIONS[ea]);
			...
			function t(b, c) {
				if (b) {
					var d = u,
						e = b + c;
					for (c = b; d[c] && !(c >= e); ) ++c;
					if (16 < c - b && d.buffer && qa)
						b = qa.decode(d.subarray(b, c));
					else {
						for (e = ""; b < c; ) {
							var f = d[b++];
							if (f & 128) {
			...
			(function () {
				...
				(function () {
					return q ||
						...
						? d(c)
						: fetch(C, { credentials: "same-origin" }).then(
								function (f) {
			...
			a._olm_get_library_version = function () {
				return (a._olm_get_library_version = a.asm.f).apply(
					null,
					arguments
				);
			};
			...
			a._olm_account_last_error = function () {
				return (a._olm_account_last_error = a.asm.h).apply(
					null,
					arguments
				);
			};
			a.__olm_error_to_string = function () {
				return (a.__olm_error_to_string = a.asm.i).apply(
					null,
					arguments
				);
			};
			...
			a._olm_session_last_error = function () {
				return (a._olm_session_last_error = a.asm.k).apply(
					null,
					arguments
				);
			};
			...
			a._olm_utility_last_error = function () {
				return (a._olm_utility_last_error = a.asm.m).apply(
					null,
					arguments
				);
			};
			...
			a._olm_pickle_account_length = function () {
				return (a._olm_pickle_account_length = a.asm.x).apply(
					null,
					arguments
				);
			};
			a._olm_pickle_session_length = function () {
				return (a._olm_pickle_session_length = a.asm.y).apply(
					null,
					arguments
				);
			};
			...
			a._olm_unpickle_account = function () {
				return (a._olm_unpickle_account = a.asm.B).apply(
					null,
					arguments
				);
			};
			a._olm_unpickle_session = function () {
				return (a._olm_unpickle_session = a.asm.C).apply(
					null,
					arguments
				);
			};
			...
			a._olm_account_identity_keys = function () {
				return (a._olm_account_identity_keys = a.asm.G).apply(
					null,
					arguments
				);
			};
			...
			a._olm_account_one_time_keys = function () {
				return (a._olm_account_one_time_keys = a.asm.K).apply(
					null,
					arguments
				);
			};
			...
			a._olm_account_max_number_of_one_time_keys = function () {
				return (a._olm_account_max_number_of_one_time_keys =
			...
			a._olm_account_fallback_key = function () {
				return (a._olm_account_fallback_key = a.asm.S).apply(
					null,
					arguments
				);
			};
			a._olm_account_unpublished_fallback_key_length = function () {
				return (a._olm_account_unpublished_fallback_key_length =
					a.asm.T).apply(null, arguments);
			};
			a._olm_account_unpublished_fallback_key = function () {
				return (a._olm_account_unpublished_fallback_key =
			...
			a._olm_create_outbound_session_random_length = function () {
				return (a._olm_create_outbound_session_random_length =
			...
			a._olm_create_inbound_session = function () {
				return (a._olm_create_inbound_session = a.asm.Y).apply(
					null,
					arguments
				);
			};
			...
			a._olm_session_id_length = function () {
				return (a._olm_session_id_length = a.asm._).apply(
					null,
					arguments
				);
			};
			...
			a._olm_session_describe = function () {
				return (a._olm_session_describe = a.asm.ba).apply(
					null,
					arguments
				);
			};
			...
			a._olm_remove_one_time_keys = function () {
				return (a._olm_remove_one_time_keys = a.asm.ea).apply(
					null,
					arguments
				);
			};
			a._olm_encrypt_message_type = function () {
				return (a._olm_encrypt_message_type = a.asm.fa).apply(
					null,
					arguments
				);
			};
			a._olm_encrypt_random_length = function () {
				return (a._olm_encrypt_random_length = a.asm.ga).apply(
					null,
					arguments
				);
			};
			...
			a._olm_ed25519_verify = function () {
				return (a._olm_ed25519_verify = a.asm.na).apply(
					null,
					arguments
				);
			};
			...
			a._olm_pk_encryption_size = function () {
				return (a._olm_pk_encryption_size = a.asm.qa).apply(
					null,
					arguments
				);
			};
			...
			a._olm_clear_pk_encryption = function () {
				return (a._olm_clear_pk_encryption = a.asm.sa).apply(
					null,
					arguments
				);
			};
			a._olm_pk_encryption_set_recipient_key = function () {
				return (a._olm_pk_encryption_set_recipient_key =
			...
			a._olm_pk_ciphertext_length = function () {
				return (a._olm_pk_ciphertext_length = a.asm.va).apply(
					null,
					arguments
				);
			};
			...
			a._olm_pk_decryption_size = function () {
				return (a._olm_pk_decryption_size = a.asm.Ba).apply(
					null,
					arguments
				);
			};
			...
			a._olm_clear_pk_decryption = function () {
				return (a._olm_clear_pk_decryption = a.asm.Da).apply(
					null,
					arguments
				);
			};
			a._olm_pk_private_key_length = function () {
				return (a._olm_pk_private_key_length = a.asm.Ea).apply(
					null,
					arguments
				);
			};
			...
			a._olm_pk_key_from_private = function () {
				return (a._olm_pk_key_from_private = a.asm.Ga).apply(
					null,
					arguments
				);
			};
			a._olm_pk_generate_key = function () {
				return (a._olm_pk_generate_key = a.asm.Ha).apply(
					null,
					arguments
				);
			};
			...
			a._olm_pickle_pk_decryption = function () {
				return (a._olm_pickle_pk_decryption = a.asm.Ja).apply(
					null,
					arguments
				);
			};
			...
			a._olm_pk_get_private_key = function () {
				return (a._olm_pk_get_private_key = a.asm.Na).apply(
					null,
					arguments
				);
			};
			a._olm_pk_signing_size = function () {
				return (a._olm_pk_signing_size = a.asm.Oa).apply(
					null,
					arguments
				);
			};
			...
			a._olm_pk_signing_last_error = function () {
				return (a._olm_pk_signing_last_error = a.asm.Qa).apply(
					null,
					arguments
				);
			};
			...
			a._olm_clear_pk_signing = function () {
				return (a._olm_clear_pk_signing = a.asm.Sa).apply(
					null,
					arguments
				);
			};
			...
			a._olm_pk_signature_length = function () {
				return (a._olm_pk_signature_length = a.asm.Wa).apply(
					null,
					arguments
				);
			};
			...
			a._olm_inbound_group_session = function () {
				return (a._olm_inbound_group_session = a.asm.Za).apply(
					null,
					arguments
				);
			};
			...
			a._olm_inbound_group_session_last_error = function () {
				return (a._olm_inbound_group_session_last_error =
					a.asm.$a).apply(null, arguments);
			};
			a._olm_inbound_group_session_last_error_code = function () {
				return (a._olm_inbound_group_session_last_error_code =
			...
			a._olm_pickle_inbound_group_session_length = function () {
				return (a._olm_pickle_inbound_group_session_length =
			...
			a._olm_group_decrypt_max_plaintext_length = function () {
				return (a._olm_group_decrypt_max_plaintext_length =
			...
			a._olm_inbound_group_session_id_length = function () {
				return (a._olm_inbound_group_session_id_length =
			...
			a._olm_inbound_group_session_is_verified = function () {
				return (a._olm_inbound_group_session_is_verified =
					a.asm.lb).apply(null, arguments);
			};
			a._olm_export_inbound_group_session_length = function () {
				return (a._olm_export_inbound_group_session_length =
			...
			a._olm_outbound_group_session_last_error = function () {
				return (a._olm_outbound_group_session_last_error =
					a.asm.rb).apply(null, arguments);
			};
			a._olm_outbound_group_session_last_error_code = function () {
				return (a._olm_outbound_group_session_last_error_code =
					a.asm.sb).apply(null, arguments);
			};
			a._olm_pickle_outbound_group_session_length = function () {
				return (a._olm_pickle_outbound_group_session_length =
			...
			a._olm_unpickle_outbound_group_session = function () {
				return (a._olm_unpickle_outbound_group_session =
			...
			a._olm_outbound_group_session_id_length = function () {
				return (a._olm_outbound_group_session_id_length =
					a.asm.Ab).apply(null, arguments);
			};
			...
			a._olm_outbound_group_session_message_index = function () {
				return (a._olm_outbound_group_session_message_index =
					a.asm.Cb).apply(null, arguments);
			};
			a._olm_outbound_group_session_key_length = function () {
				return (a._olm_outbound_group_session_key_length =
					a.asm.Db).apply(null, arguments);
			};
			...
			a._olm_sas_last_error = function () {
				return (a._olm_sas_last_error = a.asm.Fb).apply(
					null,
					arguments
				);
			};
			a._olm_sas_last_error_code = function () {
				return (a._olm_sas_last_error_code = a.asm.Gb).apply(
					null,
					arguments
				);
			};
			...
			a._olm_sas_pubkey_length = function () {
				return (a._olm_sas_pubkey_length = a.asm.Mb).apply(
					null,
					arguments
				);
			};
			a._olm_sas_get_pubkey = function () {
				return (a._olm_sas_get_pubkey = a.asm.Nb).apply(
					null,
					arguments
				);
			};
			a._olm_sas_set_their_key = function () {
				return (a._olm_sas_set_their_key = a.asm.Ob).apply(
					null,
					arguments
				);
			};
			a._olm_sas_is_their_key_set = function () {
				return (a._olm_sas_is_their_key_set = a.asm.Pb).apply(
					null,
					arguments
				);
			};
			a._olm_sas_generate_bytes = function () {
				return (a._olm_sas_generate_bytes = a.asm.Qb).apply(
					null,
					arguments
				);
			};
			a._olm_sas_mac_length = function () {
				return (a._olm_sas_mac_length = a.asm.Rb).apply(
					null,
					arguments
				);
			};
			...
			a._olm_sas_calculate_mac = function () {
				return (a._olm_sas_calculate_mac = a.asm.Tb).apply(
					null,
					arguments
				);
			};
			...
			var Oa = (a.stackSave = function () {
				...
				Pa = (a.stackRestore = function () {
					return (Pa = a.stackRestore = a.asm.Yb).apply(
						null,
						arguments
					);
				}),
				Qa = (a.stackAlloc = function () {
					return (Qa = a.stackAlloc = a.asm.Zb).apply(
						null,
						arguments
					);
				});
			...
			E.prototype.pickle = J(function (b) {
				...
				var c = G(a._olm_pickle_outbound_group_session_length)(this.$b),
					...
					e = L(c + 1);
				try {
					G(a._olm_pickle_outbound_group_session)(
						this.$b,
						d,
						b.length,
						e,
			...
			E.prototype.create = J(function () {
				var b = G(a._olm_init_outbound_group_session_random_length)(
						this.$b
					),
					c = N(b, g);
				try {
			...
			function P(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(
								a._olm_inbound_group_session_last_error(
									arguments[0]
								)
							)),
							Error("OLM." + c))
			...
			O.prototype.pickle = J(function (b) {
				...
				var c = P(a._olm_pickle_inbound_group_session_length)(this.$b),
					...
					e = L(c + 1);
				try {
					P(a._olm_pickle_inbound_group_session)(
						this.$b,
						d,
						b.length,
						e,
			...
			O.prototype.import_session = J(function (b) {
				...
				var c = L(b);
				try {
					P(a._olm_import_inbound_group_session)(
						this.$b,
						c,
						b.length
					);
			...
			O.prototype.first_known_index = J(function () {
				return P(a._olm_inbound_group_session_first_known_index)(
					this.$b
				);
			});
			...
			function R(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(
								a._olm_pk_encryption_last_error(arguments[0])
							)),
							Error("OLM." + c))
						);
					return c;
			...
			function T(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(
								a._olm_pk_decryption_last_error(arguments[0])
							)),
							Error("OLM." + c))
						);
					return c;
			...
			function Wa(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(
								a._olm_pk_signing_last_error(arguments[0])
							)),
							Error("OLM." + c))
						);
					return c;
			...
			Va.prototype.init_with_seed = J(function (b) {
				...
				var d = Wa(a._olm_pk_signing_public_key_length)(),
					e = L(d + 1);
				try {
					Wa(a._olm_pk_signing_key_from_seed)(
						this.$b,
						e,
						d,
						c,
			...
			function V(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_sas_last_error(arguments[0]))),
							Error("OLM." + c))
						);
					return c;
				};
			...
			function X(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_account_last_error(arguments[0]))),
							Error("OLM." + c))
						);
					return c;
				};
			...
			W.prototype.generate_fallback_key = J(function () {
				var b = X(a._olm_account_generate_fallback_key_random_length)(
						this.$b
					),
					c = N(b, g);
				try {
			...
			W.prototype.unpublished_fallback_key = J(function () {
				var b = X(a._olm_account_unpublished_fallback_key_length)(
						this.$b
					),
					c = L(b + 1);
			...
			function Z(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_session_last_error(arguments[0]))),
							Error("OLM." + c))
						);
					return c;
				};
			...
			Y.prototype.create_outbound = J(function (b, c, d) {
				var e = Z(a._olm_create_outbound_session_random_length)(
						this.$b
					),
					f = N(e, g);
				c = K(c);
			...
			Y.prototype.create_inbound = J(function (b, c) {
				...
				var d = L(c);
				try {
					Z(a._olm_create_inbound_session)(
						this.$b,
						b.$b,
						d,
						c.length
			...
			Y.prototype.has_received_message = function () {
				return Z(a._olm_session_has_received_message)(this.$b)
					? !0
					: !1;
			};
			...
			function Ya(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_utility_last_error(arguments[0]))),
							Error("OLM." + c))
						);
					return c;
				};
